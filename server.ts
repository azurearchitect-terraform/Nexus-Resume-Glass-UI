      ...
      if (pipelineType === 'hybrid-openai') {
        ...
        const metaPrompt = `
          ...
          * DO NOT position as Senior DevOps Engineer, Kubernetes Architect, SRE, Platform Engineer, or software developer.
          ...
          - PRESERVE ALL ORIGINAL CERTIFICATIONS: You MUST preserve and include all 3 certifications listed in the input exactly as written: "Microsoft Certified: Azure Solutions Architect Expert (AZ-305)", "Microsoft Certified: Azure Administrator Associate (AZ-104)", and "Microsoft Certified: Azure Fundamentals (AZ-900)". Do not drop, exclude, alter, or omit any of them.
